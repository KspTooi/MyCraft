...
第一阶段：游戏状态机 (Game State Machine)
    ...
    创建 com.ksptool.mycraft.sharedcore.GameState.java (新文件):
    ...
    修改 com.ksptool.mycraft.client.Game.java：
...
第二阶段：基础 UI 渲染器
    ...
    创建 com.ksptool.mycraft.client.rendering.GuiRenderer.java (新类):
...
第三阶段：实现主菜单逻辑
    ...
    创建 com.ksptool.mycraft.client.gui.MainMenu.java (新类):
