...
第一阶段：游戏状态机 (Game State Machine)
    ...
    创建 com.ksptool.mycraft.commons.GameState.java (新文件):
    ...
    修改 com.ksptool.mycraft.core.Game.java：
...
第二阶段：基础 UI 渲染器
    ...
    创建 com.ksptool.mycraft.rendering.GuiRenderer.java (新类):
...
第三阶段：实现主菜单逻辑
    ...
    创建 com.ksptool.mycraft.gui.MainMenu.java (新类):
