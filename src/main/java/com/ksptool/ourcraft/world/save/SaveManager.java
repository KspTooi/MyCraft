package com.ksptool.ourcraft.world.save;
...
public class SaveManager {
    ...
    public void savePalette(String saveName, com.ksptool.ourcraft.world.GlobalPalette palette) {
        ...
        com.ksptool.ourcraft.world.save.PaletteIndex paletteIndex = new com.ksptool.ourcraft.world.save.PaletteIndex();
        
        for (int i = 0; i < palette.getStateCount(); i++) {
            BlockState state = palette.getState(i);
            com.ksptool.ourcraft.world.save.BlockStateData stateData = new com.ksptool.ourcraft.world.save.BlockStateData();
    ...
    public boolean loadPalette(String saveName, com.ksptool.ourcraft.world.GlobalPalette palette) {
        ...
        try (FileReader reader = new FileReader(paletteFile)) {
            com.ksptool.ourcraft.world.save.PaletteIndex paletteIndex = gson.fromJson(reader, com.ksptool.ourcraft.world.save.PaletteIndex.class);
            if (paletteIndex == null || paletteIndex.states == null) {
                return false;
            }
            
            palette.clear();
            com.ksptool.ourcraft.world.Registry registry = com.ksptool.ourcraft.world.Registry.getInstance();
            
            for (com.ksptool.ourcraft.world.save.BlockStateData stateData : paletteIndex.states) {
